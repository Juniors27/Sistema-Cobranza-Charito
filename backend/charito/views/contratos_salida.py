...
class ContratosSalidaListView(APIView):
    ...
    def get(self, request):
        ...
        resumen_base = queryset.aggregate(
            ...
            bajados=Count("id", filter=Q(estado="bajada")),
            inactivos=Count("id", filter=Q(estado__in=estados_inactivos)),
            ya_pagaron=Count(
                "id",
        ...
        resumen = {
            ...
            "cancelados": resumen_base["cancelados"] or 0,
            "bajados": resumen_base["bajados"] or 0,
            "inactivos": resumen_base["inactivos"] or 0,
